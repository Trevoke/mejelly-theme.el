(deftheme mejelly
  "A port of the vim jellybeans theme.")
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (blue-0   "#0000df") ; spellcap
       (blue-1   "#2B5B77") ; diffchange bg
       (blue-2   "#345FA8") ; dbg current bg
       (blue-3   "#447799") ; rubyclass
       (blue-4   "#668799") ; delimiter
       (blue-5   "#7697d6") ; ruby symbol, ruby control
       (blue-6   "#8197bf") ; statement
       (blue-7   "#8fbfdc") ; structure, preproc, diff text fg
       (blue-8   "#b0d0f0") ; cursor bg
       (blue-9   "#DEEBFE") ; dbg current fg
       ...
       (red-9    "#dd0093") ; regexp
       (green-0  "#2D7067") ; spelllocal
       (green-1  "#405026") ; precise jump target bg
  ...
  (custom-theme-set-faces
   ...
   `(tab-bar ((,class :background ,white-8 :foreground ,black-0,:inherit (variable-pitch))))
   `(tab-bar-tab-inactive ((,class :background ,gray-7 :inherit (tab-bar))))
   `(tab-line ((,class :background ,gray-8)))

   `(tooltip ((,class :background ,black-6 :foreground ,red-8)))

   `(mode-line ((,class :background ,white-6 :foreground ,black-0 :box (:line-width -1 :style released-button))))
   ;; `(mode-line-active )
   ;; `(mode-line-buffer-id )
   ;; `(mode-line-emphasis )
   ;; `(mode-line-highlight )
   `(mode-line-inactive ((,class :foreground ,white-9 :background ,black-9 :box (:line-width -1 :color ,white-6 :style nil))))
   ...
   `(font-lock-constant-face ((,class :foreground ,red-6)))
   ...
   ;; `(magit-blame-name )
   ;; `(magit-blame-summary )
   `(magit-branch-local ((,class :foreground ,red-5)))
   ...
   `(org-block-begin-line ((,class :foreground ,white-2)))
   ;; `(org-block-end-line )
   ;; `(org-checkbox )
   ;; `(org-clock-overlay )
   ;; `(org-code )
   ...
   `(org-document-title ((,class :foreground ,red-7)))
   ;; `(org-done )
   ...
   `(org-habit-overdue-face ((,class :background ,red-4)))
   ...
   ;; `(org-tag-group )
   ;; `(org-target )
   `(org-time-grid ((,class :foreground ,green-2 :weight light)))
